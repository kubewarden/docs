...
{short-project-name} uses Hauler capabilities by providing a manifest file with all the
...
{short-project-name}. The difference from a standard {short-project-name} installation is that you

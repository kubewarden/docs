...
This guide explains how to query {sboms-name} resources with metadata
fields.
...
These examples show how to use the available fields.
...
To list SBOMs for images tagged `1.12-alpine` and built for `amd64`, run
this command:

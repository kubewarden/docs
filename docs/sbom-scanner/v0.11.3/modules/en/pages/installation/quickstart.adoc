...
To customize the CloudNativePG installation, refer to xref:installation/helm-values.adoc#using-cloudnativepg-recommended[Using CloudNativePG (Recommended)] in the Helm values documentation. You can also bring your own PostgreSQL instance instead of using CloudNativePG. See xref:installation/helm-values.adoc#using-an-external-postgresql-instance[Using an External PostgreSQL Instance] for configuration details.

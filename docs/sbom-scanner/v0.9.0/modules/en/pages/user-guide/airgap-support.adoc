...
To run the scans, {sboms-name} currently needs the following external
sources:
...
Once mirrored in your own OCI registry, you can install {sboms-name} to
point to them:
...
To configure a VEX Hub in {sboms-name}, create a `VEXHub` resource with

...
This section details a real-world deployment of {admc-name} in a demanding, large-scale environment. It illustrates how to configure {admc-short-name} for high availability and performance and what to expect under heavy load.

[IMPORTANT]
====
If you want to see more tips on how to run {admc-short-name} in production, check out the xref:/howtos/production-deployments.adoc[Production deployments] documentation.
====
...
== {admc-short-name} Configuration

To meet the demands of this environment, {admc-short-name} is configured with a focus on workload isolation and high availability.

...
be a useful tool for debugging issues in your {admc-name} deployment
and policies.
...
The official `admission-controller` helm
chart creates a PolicyServer named `default`. You want this PolicyServer
...
Deploy the {admc-short-name} stack in the usual way:

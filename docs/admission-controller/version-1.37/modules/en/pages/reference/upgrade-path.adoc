...
Please see the xref:community-specific/howtos/chart-migration.adoc[migration how-to].
...
`kubewarden-controller` Helm chart. After that, upgrade the `policy-server`

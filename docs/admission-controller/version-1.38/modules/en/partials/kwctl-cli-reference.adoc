...
* `--disable-memory-limit` — Disable policy memory limit
...
* `--policy-memory-limit <MAXIMUM_MEMORY_MIB>` — Maximum amount of linear memory, in MiB, a policy is allowed to use
+
Default value: `256`

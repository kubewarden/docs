...
:keywords: ["{admc-name}", kubewarden, kubernetes, install kwctl, install, kwctl]
:doc-persona: kubewarden-all
:doc-type: howto
:doc-topic: install-kwctl

`kwctl` is the command-line interface (CLI) tool for {admc-name}. Below are installation instructions for some operating systems.
...
. Download `kwctl`:
    .. Open your browser and go to the https://github.com/kubewarden/adm-controller/releases/latest[{admc-short-name} releases page].

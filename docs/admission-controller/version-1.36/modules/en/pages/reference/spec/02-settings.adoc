...
{admc-name} takes care of serializing the policy settings into JSON and provides
...
{admc-short-name}'s https://github.com/chimera-kube/policy-server[policy-server]

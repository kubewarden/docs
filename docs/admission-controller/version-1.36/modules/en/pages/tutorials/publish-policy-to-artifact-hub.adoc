...
{admc-name} policies can be published on Artifact Hub and made
...
This document focuses on the steps required to make a {admc-short-name} policy
...
* Choose _"{admc-short-name} policies"_ as kind.

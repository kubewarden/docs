...
As a Kubernetes cluster operator, you'll want to perform testing for {admc-name} policies you want to use.
...
{admc-short-name} has a utility, xref:/reference/kwctl-cli.adoc[`kwctl`],
...
The {admc-short-name} policy can load from the:

...
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#objectmeta-v1-meta[$$ObjectMeta$$]__
a| Refer to Kubernetes API documentation for fields of `metadata`.
...
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#listmeta-v1-meta[$$ListMeta$$]__
a| Refer to Kubernetes API documentation for fields of `metadata`.
...
| 
| 
| *`namespaceSelector`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#labelselector-v1-meta[$$LabelSelector$$]__
a| NamespaceSelector decides whether to run the webhook on an object based
...
| *`allowInsideAdmissionControllerNamespace`* __boolean__
a| AllowInsideAdmissionControllerNamespace controls whether the policy should also be
...
| *`contextAwareResources`* __xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1-contextawareresource[$$ContextAwareResource$$] array__
a| List of Kubernetes resources the policy is allowed to access at evaluation time.
...
| 
| 
| *`policies`* __xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1-policygroupmemberswithcontext[$$PolicyGroupMembersWithContext$$]__
a| Policies is a list of policies that are part of the group that will
...
a| apiVersion of the resource (v1 for core group, groupName/groupVersions for other).
| 
| 
| *`kind`* __string__
a| Singular PascalCase name of the resource
| 
| 
|===
...
|===
| Field | Description | Default | Validation
| *`policyServer`* __string__
a| PolicyServer identifies an existing PolicyServer resource.
| default
| Optional: \{} +

| *`mode`* __xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1-policymode[$$PolicyMode$$]__
a| Mode defines the execution mode of this policy. Can be set to
...
| *`rules`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#rulewithoperations-v1-admissionregistration[$$RuleWithOperations$$] array__
a| Rules describes what operations on what resources/subresources the webhook cares about.
The webhook cares about an operation if it matches _any_ Rule.
| 
| 
| *`failurePolicy`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#failurepolicytype-v1-admissionregistration[$$FailurePolicyType$$]__
a| FailurePolicy defines how unrecognized errors and timeout errors from the
...
| *`backgroundAudit`* __boolean__
a| BackgroundAudit indicates whether a policy should be used or skipped when
...
| *`matchPolicy`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#matchpolicytype-v1-admissionregistration[$$MatchPolicyType$$]__
a| matchPolicy defines how the "rules" list is used to match incoming requests.
...
| *`matchConditions`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#matchcondition-v1-admissionregistration[$$MatchCondition$$] array__
a| MatchConditions are a list of conditions that must be met for a request to be
...
| *`objectSelector`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#labelselector-v1-meta[$$LabelSelector$$]__
a| ObjectSelector decides whether to run the webhook based on if the
...
| *`sideEffects`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#sideeffectclass-v1-admissionregistration[$$SideEffectClass$$]__
a| SideEffects states whether this webhook has side effects.
...
a| TimeoutSeconds specifies the timeout for this webhook. After the timeout passes,
...
a| Expression is the evaluation expression to accept or reject the
...
| *`message`* __string__
a| Message is  used to specify the message that will be returned when
...
| Field | Description | Default | Validation
| *`module`* __string__
a| Module is the location of the WASM module to be loaded. Can be a
...
| *`settings`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#rawextension-runtime-pkg[$$RawExtension$$]__
a| Settings is a free-form object that contains the policy configuration
values.
x-kubernetes-embedded-resource: false
| 
| Optional: \{} +

| *`timeoutEvalSeconds`* __integer__
a| TimeoutEvalSeconds specifies the timeout for the policy evaluation. After
...
_Underlying type:_ _object (keys:string, values:xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1-policygroupmember[$$PolicyGroupMember$$])_
...
_Underlying type:_ _object (keys:string, values:xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1-policygroupmemberwithcontext[$$PolicyGroupMemberWithContext$$])_
...
| 
| 
| *`policies`* __xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1-policygroupmembers[$$PolicyGroupMembers$$]__
a| Policies is a list of policies that are part of the group that will
be available to be called in the evaluation expression field.
Each policy in the group should be a Kubewarden policy.
| 
...
|===
| Field | Description | Default | Validation
| *`container`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#securitycontext-v1-core[$$SecurityContext$$]__
a| securityContext definition to be used in the policy server container
| 
| Optional: \{} +

| *`pod`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#podsecuritycontext-v1-core[$$PodSecurityContext$$]__
a| podSecurityContext definition to be used in the policy server Pod
| 
| Optional: \{} +
...
a| Replicas is the number of desired replicas.
| 
| 
| *`minAvailable`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#intorstring-intstr-util[$$IntOrString$$]__
a| Number of policy server replicas that must be still available after the
eviction. The value can be an absolute number or a percentage. Only one of
MinAvailable or Max MaxUnavailable can be set.
| 
| 
| *`maxUnavailable`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#intorstring-intstr-util[$$IntOrString$$]__
a| Number of policy server replicas that can be unavailable after the
eviction. The value can be an absolute number or a percentage. Only one of
MinAvailable or Max MaxUnavailable can be set.
| 
| 
| *`annotations`* __object (keys:string, values:string)__
a| Annotations is an unstructured key value map stored with a resource that may be
...
a| Labels is a map of custom labels to be applied to the Deployment created by the
...
| *`env`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#envvar-v1-core[$$EnvVar$$] array__
a| List of environment variables to set in the container.
| 
| Optional: \{} +

| *`serviceAccountName`* __string__
a| Name of the service account associated with the policy server.
Namespace service account will be used if not specified.
| 
| Optional: \{} +

| *`imagePullSecret`* __string__
a| Name of ImagePullSecret secret in the same namespace, used for pulling
policies from repositories.
| 
| Optional: \{} +

| *`insecureSources`* __string array__
a| List of insecure URIs to policy repositories. The `insecureSources`
...
| *`sourceAuthorities`* __object (keys:string, values:string array)__
a| Key value map of registry URIs endpoints to a list of their associated
...
| *`verificationConfig`* __string__
a| Name of VerificationConfig configmap in the kubewarden namespace (same
...
| *`sigstoreTrustConfig`* __string__
a| Name of SigstoreTrustConfig configmap in the kubewarden namespace (same
...
| *`securityContexts`* __xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1-policyserversecurity[$$PolicyServerSecurity$$]__
a| Security configuration to be used in the Policy Server workload.
...
| *`affinity`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#affinity-v1-core[$$Affinity$$]__
a| Affinity rules for the associated Policy Server pods.
| 
| Optional: \{} +

| *`limits`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#resourcelist-v1-core[$$ResourceList$$]__
a| Limits describes the maximum amount of compute resources allowed.
| 
| Optional: \{} +

| *`requests`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#resourcelist-v1-core[$$ResourceList$$]__
a| Requests describes the minimum amount of compute resources required.
If Request is omitted for, it defaults to Limits if that is explicitly specified,
otherwise to an implementation-defined value
| 
| Optional: \{} +

| *`tolerations`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#toleration-v1-core[$$Toleration$$] array__
a| Tolerations describe the policy server pod's tolerations. It can be
used to ensure that the policy server pod is not scheduled onto a
node with a taint.
| 
| 
| *`priorityClassName`* __string__
a| PriorityClassName is the name of the PriorityClass to be used for the
...
| *`namespacedPoliciesCapabilities`* __string array__
a| NamespacedPoliciesCapabilities lists host capability API calls allowed
...
| *`webhookPort`* __integer__
a| Port where the policy server listens for incoming webhook requests.
...
| *`readinessProbePort`* __integer__
a| Port used by the policy server to expose the readiness probe endpoint.
...
| *`metricsPort`* __integer__
a| Port exposed by the metrics Service for this policy server.
...
| *`mutating`* __boolean__
a| Mutating indicates whether a policy has the ability to mutate
...
| 
| *`timeoutSeconds`* __integer__
a| TimeoutSeconds specifies the timeout for the policy webhook. After the timeout passes,
the webhook call will be ignored or the API call will fail based on the
failure policy.
The timeout value must be between 2 and 30 seconds.
Default to 10 seconds.
...
| *`message`* __string__
a| Message overrides the rejection message of the policy.
...
| *`verificationConfig`* __string__
a| Name of VerificationConfig configmap in the same namespace, containing
...
| *`mode`* __xref:{anchor_prefix}-github-com-kubewarden-adm-controller-api-policies-v1alpha2-policymode[$$PolicyMode$$]__
a| Mode defines the execution mode of this policy. Can be set to
either "protect" or "monitor". If it's empty, it is defaulted to
"protect".
Transitioning this setting from "monitor" to "protect" is

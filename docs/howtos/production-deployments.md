...
components in a Kubernetes cluster. Some of the hints from this page came from
community using Kubewarden at scale.
...
## Case Study: Kubewarden in a Large-Scale Environment

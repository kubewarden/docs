...
[#_tail-the-opentelemetry-collector]
...
[#_scrape-prometheus-metrics-on-9090]
...
[#_wnpstatusupdateinterval-latency]
...
[#_understand-status-fields]
== Understand status fields

[#_workloadnetworkpolicy-status]
...
[#_workloadnetworkpolicyproposal-status-conditions]

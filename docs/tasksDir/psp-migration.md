...
by people from [AppVia](https://github.com/appvia/psp-migration), to migrate PSP
automatically. With this script the PSP will be migrated for the equivalent
Kuberwarden policies.
...
:::tip
The policies names are generated by the PSP migration tool used. The

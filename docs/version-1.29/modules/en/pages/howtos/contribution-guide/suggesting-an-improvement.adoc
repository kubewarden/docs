...
If you notice an issue with {short-project-name} documentation or want to
suggest new content, then open an issue. You only require access to a
https://github.com/join[GitHub account] and a browser.

Usually, any new documentation work for {short-project-name} begins with an issue in
GitHub.
ifeval::["{build-type}" == "community"]
The https://github.com/orgs/kubewarden/teams/kubewarden-documentation[{short-project-name} documentation team] reviews, categorizes, and tags them. documentation team] reviews, categorizes, and tags them. ]
endif::[]
ifeval::["{build-type}" == "product"]
The https://github.com/orgs/rancher/teams/docs[{short-project-name} documentation team] reviews, categorizes, and tags them. documentation team] reviews, categorizes, and tags them. ]
endif::[]
...
ifeval::["{build-type}" == "community"]
  https://github.com/kubewarden/docs[documentation repository for {short-project-name}].
endif::[]
ifeval::["{build-type}" == "product"]
  https://github.com/rancher/kubewarden-product-docs[documentation repository for {short-project-name}].
endif::[]
...
ifeval::["{build-type}" == "product"]
* Navigate to https://github.com/rancher/kubewarden-product-docs/issues/new/choose[GitHub] and
  file the issue directly.
endif::[]

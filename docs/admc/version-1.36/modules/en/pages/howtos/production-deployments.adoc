...
{admc-short-name} Helm charts ship with two new values:
...
affinity and anti-affinity settings for the entire {admc-short-name} stack.
====
...
Starting from version 1.25 of the {admc-short-name} stack, the
{admc-short-name} Helm charts ship with a new value:

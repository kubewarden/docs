...
* https://github.com/kubewarden/policy-sdk-dotnet[{admc-name} .NET Core SDK]:
this provides a set of objects and functions that simplify the process of writing policies.
* https://github.com/kubewarden/policy-sdk-dotnet/tree/main/example[{admc-short-name} policy example]:

...
* https://github.com/kubewarden/kwctl[`kwctl`]: {admc-short-name}'s default CLI tool that helps you with policy-related operations; pull, inspect, annotate, push, and run.

...
:description: How to use a custom OpenTelemetry Collector with {short-project-name}.
...
You need encrypted communication between the {short-project-name} components
...
Now you install https://prometheus.io/[Prometheus] to store and visualize
metrics.

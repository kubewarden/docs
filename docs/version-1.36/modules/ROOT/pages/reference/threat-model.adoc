...
=== {short-project-name} threat 2 - Attacker uses namespaced policy to extract information
...
=== {short-project-name} threat 3 - PolicyServer compromise exposes all its mapped namespaces
...
=== {short-project-name} threat 4 - Stale or outdated Namespace-to-PolicyServer mapping

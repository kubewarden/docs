...
Users may also want to use GitHub to sign their policies. In which case, they need to install [Github actions](https://docs.sigstore.dev/quickstart/quickstart-cosign/#github-action)

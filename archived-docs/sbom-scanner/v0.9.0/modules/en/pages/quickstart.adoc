...
Follow these simple steps from your local machine to get {sboms-name} up
and running:
...
By default, the installation of {sboms-name} is configured to be highly
...
At this point, your {sboms-name} deployment is up and running
...
for {sboms-name} to fetch images.
